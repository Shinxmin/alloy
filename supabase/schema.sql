...
-- 계좌 관리(증권사/계좌명) 목록 저장용. [{ id, broker, accountName }, ...] 형태의 jsonb.
alter table public.portfolios add column if not exists broker_accounts jsonb not null default '[]'::jsonb;
